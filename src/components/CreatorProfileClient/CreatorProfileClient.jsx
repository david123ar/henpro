...
export default function CreatorProfileClient({ user }) {
  ...
  return (
    <div className="relative flex flex-col h-screen text-white overflow-hidden bg-[#0b0b0b]">
      ...
      {/* 🔝 Top Ad (10%) */}
      <div className="flex justify-center items-center flex-[0.15] z-10 p-2">
        <div
          className="flex justify-center items-center w-full max-w-4xl rounded-lg"
      ...
      {/* 🔻 Bottom Ad (15%) */}
      <div className="flex justify-center items-center flex-[0.15] z-10 p-2 mb-1">
        <div
          className="flex justify-center items-center w-full max-w-4xl rounded-lg"
          style={{ backgroundColor: "#201f31" }}
        >
